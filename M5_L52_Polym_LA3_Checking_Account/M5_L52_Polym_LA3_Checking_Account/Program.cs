...
namespace M5_L52_Polym_LA3_Checking_Account
{
    ...
    public class CheckingAccount : Account
    {
        ...
        {
            //ToDo
            if (TransactionCount <= TransactionLimit) Value -= AccountFee;
            else Value = Value - AccountFee - (TransactionCount - TransactionLimit) * TransactionFee;
        }
    }
    class Program
    {
