...
namespace M5_L53_Static_LA1_Guessing_Game
{
    public class GussingGame
    {
        ...
        public static void GiveHints(int guess)
        {
            ...
            if (CheckWin(guess) == 1) Console.WriteLine("Guess Higher");
            else if (CheckWin(guess) == -1) Console.WriteLine("Guess Lower");
        ...
        public static int WhoesTurn()
        {
            ...
            // If you modulo the total number of steps  by the total number of player, you get the reminder with correcpond to the player ID
        ...
        public int Play()
        {
            ...
            Steps++;
            //Console.WriteLine("Guess a number in range {0} to {1}: ", LOW, HIGH);
            Console.WriteLine("Please enter your guess {0}: ", GetPlayerName());
            //Console.WriteLine("Now playing player {0}: ", WhoesTurn());
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Conslole.Read(); // Nedd to press enter to continue
            //Thread.Sleep(1000); // hint given for 1 second and desapear
            int currentGuess;
            do
            {
                Console.Clear();
